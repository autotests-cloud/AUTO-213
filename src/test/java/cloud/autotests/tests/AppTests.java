...
public class AppTests extends TestBase {
    ...
    void titleTest() {
        step("Open url 'https://qameta.io'", () ->
            open("https://qameta.io"));

        step("Page title should have text 'Allure TestOps: Next-gen Software Quality Management Platform - Qameta.io'", () -> {
            String expectedTitle = "Allure TestOps: Next-gen Software Quality Management Platform - Qameta.io";
